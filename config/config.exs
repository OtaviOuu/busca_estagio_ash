...
config :busca_estagio, BuscaEstagioWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: BuscaEstagioWeb.ErrorHTML, json: BuscaEstagioWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: BuscaEstagio.PubSub,
  live_view: [signing_salt: "VnBUniSI"]
...
config :busca_estagio, BuscaEstagio.Mailer, adapter: Swoosh.Adapters.Local
